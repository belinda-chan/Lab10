...
const Actor = require('../movieAng/models/Actor');
const Movie = require('../movieAng/models/Movie');
...
//Delete all actors who are <15 years old
    // deleteUnderFif: function (req, res){
    //     Actor.deleteMany({bYear:{$gte:2004}}, function (err, actors){
    //         if(err){
    //             return res.status(404).json(err);
    //         }else{
    //             res.json(actors);
